...
class OrderDetailsController {
    async createOne(req, res) {
        const { count, product, order } = req.body;

        try {
            const createdOrderDetail = await OrderDetailsService.createOne([count, product, order]);
    ...
    async updateOne(req, res) {
        ...
        try {
            const updatedOrderDetail = await OrderDetailsService.updateOne(req.params.id, [count, product, order]);
